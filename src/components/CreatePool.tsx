    ...
    <div className="mx-auto max-w-lg px-4 py-8">
      <div className="flex items-center gap-3 mb-6">
        <button
          ...
          className="p-2 bg-gray-100 dark:bg-[#1a1a1a] rounded-xl hover:bg-gray-200 dark:hover:bg-[#2a2a2a] transition"
        >
      ...
      <div className="space-y-4">
        ...
        {!existingPool ? (
          <>
            ...
            {isCreating && (
              <p className="text-center text-xs text-amber-600 dark:text-amber-400 mt-2 animate-pulse">
                {t("create_tx_waiting")}
              </p>
            )}
          </>
          ...
          <div className="rounded-xl border border-amber-200 bg-amber-50 dark:bg-amber-900/20 dark:border-amber-800 p-4 mt-4 text-center">
            ...
            <p className="text-xs text-amber-600/80 dark:text-amber-400/80 mb-4 text-left">
              {t("create_pair_desc")}
            </p>
            <button
              onClick={handleIssueLp}
              className="w-full px-4 py-3 bg-amber-500 text-white rounded-xl text-sm font-bold hover:bg-amber-600 transition shadow-sm"
            >
          ...
          <div className="rounded-xl border border-green-200 bg-green-50 dark:bg-green-900/20 dark:border-green-800 p-6 mt-4 text-center">
            ...
            <p className="text-base font-bold text-green-700 dark:text-green-400 mb-2">
            ...
            <button
              ...
              className="w-full px-4 py-3 bg-green-500 text-white rounded-xl text-sm font-bold hover:bg-green-600 transition shadow-sm"
            >
